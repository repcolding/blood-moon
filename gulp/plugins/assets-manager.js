...
import { regHtmlUrl, getNewAssets, replaceAssetsUrl, getElPath } from '../helpers/modules-assets.js'

const assetsManager = () => through2(async function (file, enc, callback) {
  ...
  file.contents = new Buffer(
    replaceAssetsUrl(htmlFile, replaceList)
  )
